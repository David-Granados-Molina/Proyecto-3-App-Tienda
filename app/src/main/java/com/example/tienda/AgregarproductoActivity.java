...
public class AgregarproductoActivity extends AppCompatActivity {
    ...
    private EditText nombrepro, descripcionpro, tallapro, preciopro, cantidadpro;
    ...
    private String Categoria, Nom, Desc, TallaPro, Precio
, Cant, CurrentDate, CurrentTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tallapro = (EditText) findViewById(R.id.tallapro);
        ...
        textox.setText("Agregar "+Categoria);
    }
    ...
    private void ValidarProducto() {
        ...
        TallaPro = tallapro.getText().toString();
        ...
        if (imagenUri == null){
            ...
            Toast.makeText(this, "Debes agregar un nombre al producto", Toast.LENGTH_SHORT).show();
        }else if (TextUtils.isEmpty((Desc))){
            Toast.makeText(this, "Debes agregar una descripción al producto", Toast.LENGTH_SHORT).show();
        }else if (TextUtils.isEmpty((TallaPro))){
            Toast.makeText(this, "Debes agregar una talla al producto", Toast.LENGTH_SHORT).show();
        }else if (TextUtils.isEmpty((Precio))){
            Toast.makeText(this, "Debes agregar un precio de venta del producto", Toast.LENGTH_SHORT).show();
        }else if (TextUtils.isEmpty((Cant))){
            Toast.makeText(this, "Debes agregar una cantidad del producto", Toast.LENGTH_SHORT).show();
        }else{
    ...
    private void GuardarInformacionProducto() {
        ...
        dialog.setMessage("Por favor, espera mientras guardamos el producto...");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AgregarproductoActivity.this, "Imagen guardada con éxito", Toast.LENGTH_SHORT).show();
        ...
        ProductoRef.child(productoRandonKey).updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    dialog.dismiss();
                    Toast.makeText(AgregarproductoActivity.this, "Solicitud con éxito", Toast.LENGTH_SHORT).show();
                }else{
                    dialog.dismiss();
