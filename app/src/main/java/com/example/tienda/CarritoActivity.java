...
import com.example.tienda.Modal.Carrito;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Carrito, CarritoViewHolder> adapter = new FirebaseRecyclerAdapter<Carrito, CarritoViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CarritoViewHolder holder, int position, @NonNull Carrito model) {
                ...
                holder.carProductoTalla.setText("Talla: "+model.getTalla());
            ...
            public CarritoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.carrito_item_layout, parent, false);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if (estado.equals("Enviado")){
                        TotalPrecio.setText(nombre+", el pedido ha sido enviado");
                        recyclerView.setVisibility(View.GONE);
                        mensaje1.setText("El pedido se enviará pronto");
                        mensaje1.setVisibility(View.VISIBLE);
                        Siguiente.setVisibility(View.GONE);
                    }else if (estado.equals("No Enviado")){
                        TotalPrecio.setText("La orden está siendo procesada...");
                        recyclerView.setVisibility(View.GONE);
                        mensaje1.setVisibility(View.VISIBLE);
                        Siguiente.setVisibility(View.GONE);
                        Toast.makeText(CarritoActivity.this, "Puedes seguir comprando cuando acabe la anterior orden", Toast.LENGTH_SHORT).show();
                    }
                }
            }
